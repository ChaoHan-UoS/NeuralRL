# Copied from: https://github.com/dtak/mbrl-smdp-ode/tree/master
...
class RunningStats(object):
    ...
    def __init__(self, device, dim, n=0., m=None, s=None):
        self.n = n  # number of data points seen so far
        self.m = m  # running mean
        self.s = s  # running sum of squared differences from the mean
        self.dim = dim
        self.device = device
