# Adapted From: https://github.com/Farama-Foundation/Gymnasium/blob/main/gymnasium/envs/mujoco/walker2d_v4.py
...
class Walker2dBase(Walker2dEnv, CustomEnvClass):
    F_S = 18
    F_A = 6
    ...
    def __init__(
        ...
        CustomEnvClass.__init__(self, 'walker2d-base')
...
class Walker2dWindGaussian(Walker2dBase):
    def __init__(
            self,
            forward_reward_weight=1.0,
            ctrl_cost_weight=1e-3,
        ...
        CustomEnvClass.__init__(self, 'walker2d-gauss-wind')
...
class POMDPWalker2dNoPosition(Walker2dWindGaussian):
    F_S = 16
    F_A = 6
    ...
    def __init__(
        ...
        self.env_name = 'walker2d-gauss-wind-no-pos'
        self.mask = np.ones(18).astype('bool')
...
class POMDPWalker2dNoVelocity(Walker2dWindGaussian):
    F_S = 17
    F_A = 6
    ...
    def __init__(
        ...
        self.env_name = 'walker2d-gauss-wind-no-vel'
        self.mask = np.ones(18).astype('bool')
...
if __name__ == "__main__":
    env = Walker2dWindGaussian(render_mode='human', terminate_when_unhealthy=False)
